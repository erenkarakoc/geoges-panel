...
export const AUDIT_EVENT_LABELS: Readonly<Record<string, string>> = {
  ...
  "workflow.deleted": "Akış silindi",
  "workflow.archived": "Akış arşive kaldırıldı",
  "workflow.restored": "Akış arşivden geri getirildi",
  "workflow.reopened": "Akış yeniden açıldı",
  "workflow.template_removed": "Şablon listeden kaldırıldı",
  "workflow.template_restored": "Şablon geri getirildi",
...
export const AUDIT_TARGET_TABLES = [
  ...
  { value: "wfl.flow", label: "Akış" },
  { value: "wfl.flow_version", label: "Akış sürümü" },
  { value: "wfl.template", label: "Akış şablonu" },
