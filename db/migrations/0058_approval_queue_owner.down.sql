-- Reverses 0058_approval_queue_owner.sql: the queue's answer loses the column that says whose
-- approval it is, and goes back to only saying that a delegation brought it here.
