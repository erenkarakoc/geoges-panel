-- Restore the previous writers/readers before dropping their metadata.
...
drop function core.assert_search_normalization(text[]);
alter table core.search_posting drop column projection_version, drop column normalization_version;
alter table core.search_row drop column normalization_version;
drop function core.search_normalization_version();
