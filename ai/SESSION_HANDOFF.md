...
- **REQ-RPT §34** — REQ-RPT-015…023, D-206…D-208, DRAFT.
...
1. Owner confirms or corrects REQ-RPT-015…023; mark CONFIRMED.
2. Continue with NFR, following the same pattern (scope → open questions only → D-NNN → REQ file with catalog → glossary first → records → commit).
