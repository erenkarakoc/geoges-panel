...
## RECENT DECISIONS
- 2026-09-19: Phase 01 still open — permission matrix confirmed (TASK-0045, D-215); open: domain model (TASK-0046), slice order and pilot users (TASK-0047); KVKK inventory deferred (D-214, DEF-007)
