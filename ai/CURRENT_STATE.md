...
OQ-035 awaits the owner and a legal opinion (tied to OQ-024): the KVKK cross-border basis for the product MCP channel and whether the HR module is an administrator setting on it. It blocks only TASK-0114 (Phase 15M), nothing in Phase 07.
