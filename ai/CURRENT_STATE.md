...
CURRENT SUBPHASE:    IMPLEMENT — TASK-0121 and TASK-0122 built (TESTING); TASK-0123 IMPLEMENTING, steps 1-2 of 5
                     done (migrations 0064-0065, D-292); next: step 3, daily targets. 2026-09-26 also:
                     designer names and removal (D-293, 0067), known answers chosen not typed (D-294);
                     browser pass of the last fixes owed (pane signed out)
CURRENT FEATURE:     —
