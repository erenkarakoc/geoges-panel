...
- **Validation finding (2026-09-20):** D-247 / CHG-007 adopted and folded. TASK-0091 one-call search: 18 x 20 samples max 190 ms; 19 additional request/security checks passed. New-connection diagnostics retain 392 ms and 529 ms failures; the latter includes 445 ms server work. Replay gate FAIL (OQ-029); next separate actual backend startup from pool reuse. Eight spikes complete; search remains REVIEW before SPIKE-14. No criterion waived.
