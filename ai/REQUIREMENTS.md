...
| SUP | §25.7 | `docs/requirements/REQ-SUP.md` | 5 (CONFIRMED) |
...
| STR | §35 | `docs/requirements/REQ-STR.md` | 8 (CONFIRMED) |
...
| NFR (UI standards, alerts, platform) | §1, §39–§43, §40.2, §46 | `docs/requirements/REQ-NFR.md` | 20 (CONFIRMED) |
