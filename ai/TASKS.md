...
| TASK-0023 | Scaffold: Next.js 16 + TypeScript + Tailwind v4 + COSS UI, module folders, lint/format/boundary rules, test setup | T2 | NOT_STARTED | TASK-0022 | Provisional package manager (OQ-017) |
