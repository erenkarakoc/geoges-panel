...
| SPIKE-12 | PostgreSQL araması Türkçe için yeterli mi? | "sogut" → "Söğüt", "hakedis" → "hakediş" buluyor; yetkisiz kayıt sonuca hiç girmiyor; 500 bin arama satırında 300 ms altında | **KALDI 2026-09-20: boş sonuçlarda hız sınırı aşılıyor** → `SPIKE-12-turkish-search.md` · TASK-0091, ADR-017 yeniden incelemede; D-239, REQ-NFR-012 |
...
2026-09-20: SPIKE-12 hızdan kaldı. Sıradaki çalışma TASK-0091 ile aynı denemenin sorgu/indeks düzenini düzeltip yeniden sınamak; ardından SPIKE-14. Sekiz deneme geçti; SPIKE-12 tamamlandı sayılmaz.
