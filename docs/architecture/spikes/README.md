...
| SPIKE-12 | PostgreSQL araması Türkçe için yeterli mi? | "sogut" → "Söğüt", "hakedis" → "hakediş" buluyor; yetkisiz kayıt sonuca hiç girmiyor; 500 bin arama satırında 300 ms altında | **İNCELEMEDE 2026-09-20:** D-247 model onaylı; tek çağrıda 360 ölçüm en çok 190 ms, ilk isteklerde 392/529 ms; son aşımın 445 ms’si sunucuda → `SPIKE-12-search-retry.md`. İlk başarısızlık: `SPIKE-12-turkish-search.md` · TASK-0091, OQ-029, ADR-017, REQ-NFR-012 |
...
2026-09-20: D-247 ile model onaylandı; TASK-0091 tek çağrılı aramada ilerledi ama 392/529 ms ilk istekler nedeniyle açık. Sonraki iş backend başlangıcı ile havuz yeniden kullanımını ayırmak, sonra SPIKE-14. Sekiz deneme tamamlandı; hedef gevşetilmedi (OQ-029).
