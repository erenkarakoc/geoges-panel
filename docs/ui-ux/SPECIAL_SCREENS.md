...
| SCR-015 Bildirim çekmecesi | Üst bardaki zilden. Masaüstünde `Popover`, telefonda `Drawer`. Türe göre süzme; her bildirim kaynağına gider | `Popover`, `Drawer`, `ToggleGroup`, `ScrollArea`, `Empty` |
