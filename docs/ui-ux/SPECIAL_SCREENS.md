...
| SCR-015 Bildirim çekmecesi | Üst bardaki zilden. Masaüstünde `Popover`, telefonda `Drawer`. Türe göre süzme, başlığın yanındaki açılır listeyle (Tümü, Görevler, Onay ve düzeltme, Kritik; sahip isteği 2026-09-22); her bildirim kaynağına gider | `Popover`, `Drawer`, `Select`, `ScrollArea`, `Empty`, `Badge`. Altında telefon bildirimi anahtarı: izin yoksa "panelde eksiksiz durur" notu, iPhone'da "Ana Ekrana Ekle" yönergesi (D-252) |
